...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void notifyWearable(int weatherId, double high, double low) {
        ...
        if (mGoogleApiClient != null) {
            ...
            final PutDataMapRequest putDataMapRequest = PutDataMapRequest.create(WEARABLE_REQUEST_PATH);
            final DataMap dataMap = putDataMapRequest.getDataMap();
            dataMap.putAsset(KEY_WEATHER_ICON, createAssetFromResourceId(iconId));
            dataMap.putString(KEY_TEMPERATURE_HIGH, Utility.formatTemperature(getContext(), high));
            dataMap.putString(KEY_TEMPERATURE_LOW, Utility.formatTemperature(getContext(), low));
                    ...
                    .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                        ...
                        public void onResult(DataApi.DataItemResult dataItemResult) {
                            if (dataItemResult.getStatus().isSuccess()) {
                                Log.d(LOG_TAG, "Successfully notified wearable");
                            } else {
                                Log.d(LOG_TAG, "Failed to notify wearable");
                            }
                        }
                    });
        }
